  ...
  return (
    <footer className="bg-footer mt-10">
        <div className="flex justify-evenly py-28">
            ...
            <div>
                <h6 className="text-white font-normal text-3xl">Become an Early Adopter</h6>
                <br />
                <input type="text" placeholder="Enter your Email-Address" className="bg-footer border-b-2 font-medium text-base border-b-neutral-100" />
            </div>
            
            <div>
               <button className="bg-submitButton mt-5 w-44 h-14 rounded-full font-medium text-xl bg-submitButton">Submit</button> 
            </div>
